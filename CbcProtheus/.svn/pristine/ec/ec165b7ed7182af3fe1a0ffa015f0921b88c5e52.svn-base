...
user function cbcQRYcustVend(cOrigem, cAno, cMes)
	local cQry	:= ''
	...
	elseif cOrigem == 'pedido'
		...
		cQry += "  AND SF4.F4_DUPLIC		=	'S' "
		cQry += "  AND SC5.C5_CLIENTE NOT IN ('017449','017826','016227','017813','010188','017010','013478','015678','017011', '011248', '012677') "
	endif
return (cQry)