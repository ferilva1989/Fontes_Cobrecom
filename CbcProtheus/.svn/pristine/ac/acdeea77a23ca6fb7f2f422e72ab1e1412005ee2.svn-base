...
TRCell():New(oSecK200,"QTD"     ,cAliK200,"Quantidade",cPicQtdOld,nTamQtd,,,,,,,,,,,)	
...
TRCell():New(oSecK220,"QTD_ORI"   ,cAliK220,'Quant. Origem',cPicQtd,nTamQtd,,,,,,,,,,,)	
TRCell():New(oSecK220,"QTD_DEST"  ,cAliK220,"Quant. Destino",cPicQtd,nTamQtd,,,,,,,,,,,)
...
TRCell():New(oSecK265,"COD_OP_OS"	,cAliK265,"OP/OS",,nSpace,,,,,,,,,,,)
...
TRCell():New(oSecK280,"QTD_COR_P"	,cAliK280,"Qtd. Pos.",cPicQtdOld,nTamQtd,,,,,,,,,,,)
TRCell():New(oSecK280,"QTD_COR_N"	,cAliK280,"Qtd. Neg",cPicQtdOld,nTamQtd,,,,,,,,,,,)
...
//³ Sessao K290                         ³
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
oSecK290 := TRSection():New(oReport,"Registro K290",{cAliK290})
oSecK290:SetReadOnly()
oSecK290:SetEditCell(.F.) //Bloqueia a edicao de celulas e filtros do relatorio

TRCell():New(oSecK290,"REG"			,cAliK290,"Registro",,nSpace,,,,,,,,,,,)
TRCell():New(oSecK290,"DT_INI_OP"  	,cAliK290,"DT. Ini. OP",,nSpace,,,,,,,,,,,)
TRCell():New(oSecK290,"DT_FIN_OP" 	,cAliK290,"DT. Fin. OP",,nSpace,,,,,,,,,,,)
TRCell():New(oSecK290,"COD_DOC_OP"	,cAliK290,"Número OP",,nSpace,,,,,,,,,,,)

//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
//³ Sessao K291                         ³
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
oSecK291 := TRSection():New(oReport,"Registro K291",{cAliK291})
oSecK291:SetReadOnly()
oSecK291:SetEditCell(.F.) //Bloqueia a edicao de celulas e filtros do relatorio

TRCell():New(oSecK291,"REG"			,cAliK291,"Registro",,nSpace,,,,,,,,,,,)
TRCell():New(oSecK291,"COD_DOC_OP"  ,cAliK291,"Número OP",,nSpace,,,,,,,,,,,)
TRCell():New(oSecK291,"COD_ITEM" 	,cAliK291,"Código",,nTamProd+nSpace,,,,,,,,,,,)
TRCell():New(oSecK291,"QTD"			,cAliK291,"Quantidade",cPicQtd,nTamQtd,,,,,,,,,,,)

//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
//³ Sessao K292                         ³
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
oSecK292 := TRSection():New(oReport,"Registro K292",{cAliK292})
oSecK292:SetReadOnly()
oSecK292:SetEditCell(.F.) //Bloqueia a edicao de celulas e filtros do relatorio

TRCell():New(oSecK292,"REG"			,cAliK292,"Registro",,nSpace,,,,,,,,,,,)
TRCell():New(oSecK292,"COD_DOC_OP"  ,cAliK292,"Número OP",,nSpace,,,,,,,,,,,)
TRCell():New(oSecK292,"COD_ITEM" 	,cAliK292,"Código",,nTamProd+nSpace,,,,,,,,,,,)
TRCell():New(oSecK292,"QTD"			,cAliK292,"Quantidade",cPicQtd,nTamQtd,,,,,,,,,,,)
...
TRCell():New(oSecK300,"REG"			,cAliK300,"Registro",,nSpace,,,,,,,,,,,)
...
TRCell():New(oSecK301,"REG"			,cAliK301,"Registro",,nSpace,,,,,,,,,,,)
...
TRCell():New(oSecK302,"REG"			,cAliK302,"Registro",,nSpace,,,,,,,,,,,)
...
Local oSecK290		:= oReport:Section(16)
Local oSecK291		:= oReport:Section(17)
Local oSecK292		:= oReport:Section(18)
Local oSecK300		:= oReport:Section(19)
Local oSecK301		:= oReport:Section(20)
Local oSecK302		:= oReport:Section(21)
Local oSecK990		:= oReport:Section(22)
Local oSec0210		:= oReport:Section(23)
Local oSec0200		:= oReport:Section(24)
Local nX
...
If !oReport:Cancel()
	...
	aIndices := SPDBlocoK(dDataDe,dDataAte,@aAlias,aAliProc,lEstrMov,lSum,.F.,.F.)
	...
	oSec0200:Finish()
	oReport:PrintText(" ")
	oReport:PrintText("Configurações Utilizadas na Extração do Bloco K"  )
	oReport:ThinLine()
	BlkQryCfg(oReport)
	oReport:PrintText(" ")
EndIf
