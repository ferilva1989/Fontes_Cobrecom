...
/*
	...
	EndIf
*/
		_aChave := {cNota,cSerie,cClieFor,cLoja,cTipo} // By Roberto Oliveira

		aParam := {	aProd,		cMensCli,	cMensFis,	aDest,		aNota,;
		aInfoItem,	aDupl,		aTransp,	aEntrega,	aRetirada,;
		aVeiculo,	aReboque,	aNfVincRur,	aEspVol,	aNfVinc,	aDetPag,	aObsCont, aPedCom,	_aChave}
		...
		If ( Len(aParam) >= 5 )
			...
			aDetPag		:= aParam[16]
			aObsCont    := aParam[17]
			aPedCom   	:= aParam[18] // By Roberto Oliveira
		EndIf
		//By Juliana Leme - 06/05/2016
